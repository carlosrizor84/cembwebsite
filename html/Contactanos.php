...
{
   $mailto = 'cembdireccion@gmail.com';
   $mailfrom = isset($_POST['email']) ? $_POST['email'] : $mailto;
   $subject = 'Website form';
   $message = '<font style="color:#000000;font-family:MS Sans Serif;font-size:16px">Mensaje enviado desde el Sitio Web:<br><br>Nombre: $name<br>Correo: $email<br>Telefono: $phone<br>Mensaje: $message<br></font><font style="color:#000000;font-family:Arial;font-size:16px"><br></font>';
   $success_url = './GraciasForm.php';
   $error_url = '';
   $eol = "\n";
   $error = '';
...
<li class="nav-item">
<a href="./Contactanos.php" class="nav-link active">Contáctanos</a>
</li>
</ul>
</div>
</div>
...
<h1 id="Heading9">Contáctanos</h1>
</div>
<div id="wb_Shape4" style="display:inline-block;width:112px;height:3px;z-index:4;position:relative;">
<div id="Shape4"></div>
</div>
<div id="wb_Heading8" style="display:inline-block;width:100%;z-index:5;">
<h2 id="Heading8">¿Tienes una pregunta o quieres información para en futuro?</h2>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-1">
<div id="wb_Breadcrumb2" style="display:inline-block;width:100%;z-index:6;vertical-align:top;">
<ul id="Breadcrumb2">
<li><a href="https://goo.gl/maps/8ruemHHpD4qqrUcX8"><i class="fa fa-map-marker">&nbsp;</i>Km 132 Carretera a Somotillo. Chinandega.</a></li>
</ul>

</div>
</div>
<div class="col-2">
<div id="wb_Breadcrumb4" style="display:inline-block;width:100%;z-index:7;vertical-align:top;">
<ul id="Breadcrumb4">
<li><a href="tel:+505-2341-2923" title="Direcci&#243;n"><i class="fa fa-phone">&nbsp;</i>Direcci&#243;n:&nbsp;&nbsp; &nbsp;&nbsp; +505-8955-1033</a></li>
</ul>

</div>
<div id="wb_Breadcrumb5" style="display:inline-block;width:100%;z-index:8;vertical-align:top;">
<ul id="Breadcrumb5">
<li><a href="tel:+505-2340-1109" title="Educaci&#243;n Inicial"><i class="fa fa-phone">&nbsp;</i>Educaci&#243;n:&nbsp;&nbsp;&nbsp; +505-8757-5452</a></li>
</ul>

</div>
<div id="wb_Breadcrumb6" style="display:inline-block;width:100%;z-index:9;vertical-align:top;">
<ul id="Breadcrumb6">
<li><a href="tel:+505-2340-1430" title="Coordiandor Primaria"><i class="fa fa-phone">&nbsp;</i>Primaria:&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; +505-8787-7826</a></li>
</ul>

</div>
<div id="wb_Breadcrumb7" style="display:inline-block;width:100%;z-index:10;vertical-align:top;">
<ul id="Breadcrumb7">
<li><a href="tel:+505-2340-1273" title="Coordinador Secundaria"><i class="fa fa-phone">&nbsp;</i>Secundaria:&nbsp; +505-7790-1877</a></li>
</ul>

</div>
</div>
<div class="col-3">
<div id="wb_Breadcrumb3" style="display:inline-block;width:100%;z-index:11;vertical-align:top;">
<ul id="Breadcrumb3">
<li><a href="mailto:m.callejas@manticaberio.edu.ni"><i class="fa fa-envelope-o">&nbsp;</i>m.callejas@manticaberio.edu.ni</a></li>
</ul>
...
<form name="LayoutGrid8" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" id="LayoutGrid8">
...
<div class="row">
<div class="col-1">
<input type="text" id="editboxName" style="display:block;width: calc(100% - 10px);height:34px;z-index:12;" name="name" value="" spellcheck="false" required placeholder="Nombre">
</div>
<div class="col-2">
<input type="text" id="editboxEmail" style="display:block;width: calc(100% - 20px);height:34px;z-index:13;" name="email" value="" spellcheck="false" required placeholder="Email">
</div>
<div class="col-3">
<input type="text" id="editboxPhone" style="display:block;width: calc(100% - 10px);height:34px;z-index:14;" name="phone" value="" spellcheck="false" required placeholder="Tel&#233;fono">
</div>
</div>
</div>
</div>
<textarea name="message" id="editboxMessage" style="display:block;width: 100%;;height:100px;z-index:16;" rows="4" cols="91" autocomplete="off" spellcheck="false" required placeholder="Mensaje"></textarea>
<div id="wb_Text11">
<span style="color:#B22222;">* Todos los campos son requeridos. </span>
</div>
<input type="submit" id="Button1" name="" value="Submit" style="display:inline-block;width:92px;height:39px;z-index:18;">
</div>
</div>
</form>
</div>
...
<div class="col-1">
<!-- mapsCEMB -->
<div id="Html2" style="display:inline-block;width:100%;height:100px;z-index:19">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3893.1506821573503!2d-87.12421308586795!3d12.638118025529044!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f70f197d55a048b%3A0xce8e892fa6dc9a5f!2sCentro%20Educacional%20Mantica%20Berio!5e0!3m2!1ses!2sni!4v1611153020598!5m2!1ses!2sni" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></div>
</div>
</div>
</div>
</div>
<div id="stickyLayer" style="position:fixed;text-align:left;left:0px;top:50%;margin-top:39px;width:140px;height:63px;z-index:38;">
</div>
<div id="wb_Footer">
<div id="Footer">
<div class="row">
<div class="col-1">
<div id="wb_FontAwesomeIcon3" style="display:inline-block;width:40px;height:40px;text-align:center;z-index:23;">
<a href="https://www.facebook.com/cemanticaberio" target="_blank"><div id="FontAwesomeIcon3"><i class="fa fa-facebook"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon11" style="display:inline-block;width:40px;height:40px;text-align:center;z-index:24;">
...
<div id="wb_IconFont1" style="display:inline-block;width:40px;height:40px;text-align:center;z-index:25;">
...
<!-- POPUP -->
<div id="Html3" style="display:none;width:35px;height:24px;z-index:28">
